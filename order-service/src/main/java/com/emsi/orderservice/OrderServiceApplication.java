...
import com.emsi.orderservice.repo.OrderRepository;
import com.emsi.orderservice.repo.ProductItemRepository;
...
public class OrderServiceApplication {
	...
	CommandLineRunner start(
		...
		return args -> {
			...
			for (int i = 0; i <20 ; i++) {
				System.out.println(customers.get(random.nextInt(customers.size())).getId());
